...
class ATL_NO_VTABLE CLiveExdiGdbSrvServer :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CLiveExdiGdbSrvServer, &CLSID_LiveExdiGdbSrvServer>,
    public IeXdiServer3,
...
DECLARE_NOT_AGGREGATABLE(CLiveExdiGdbSrvServer)

BEGIN_COM_MAP(CLiveExdiGdbSrvServer)
...
OBJECT_ENTRY_AUTO(__uuidof(LiveExdiGdbSrvServer), CLiveExdiGdbSrvServer)
